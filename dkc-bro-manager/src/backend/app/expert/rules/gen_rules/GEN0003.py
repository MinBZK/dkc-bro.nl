...
class GEN0003(superRule):
    ...
    __feedbackMessage = "Domein Kader Aanlevering (deliveryContext) is ongeldig ingevuld. De gevonden waarde is: '%s'."  # Domein Kader Aanlevering (deliveryContext) is niet gelijk aan publieke taak uitvoering (publiekeTaak) of rechtsgrond waterwet (WW).
